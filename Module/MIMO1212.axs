MODULE_NAME='MIMO1212'(DEV BRAND_MODEL_vdv_Device, DEV BRAND_MODEL_Client_Device)
...
VOLATILE CHAR BRAND_MODEL_IP_ADDR[100] = '10.162.4.201'
...
DEFINE_CALL 'BRAND_MODEL_APERTURA_PORTA'
{
	...
	SEND_STRING 0,"'MIMO1212, IP NOT SET'"
    }
}
...
DEFINE_CALL 'BRAND_MODEL_INTERPRETA_MESSAGGIO'(CHAR TXT[])
{
	...
	ACTIVE (FIND_STRING(TXT,"'DATA INFO_NAME '",1)) :
	{
	    ...
	    INFO_NAME = TXT
	    IF (BRAND_MODEL_DEBUG) SEND_STRING 0, "'MIMO1212 - NAME: ', INFO_NAME"
	}
	ACTIVE (FIND_STRING(TXT,"'DATA INFO_MODEL '",1)) :
	{
	    REMOVE_STRING(TXT,"'DATA INFO_MODEL '",1)
	    INFO_MODEL = TXT
	    IF (BRAND_MODEL_DEBUG) SEND_STRING 0, "'MIMO1212 - MODEL: ', INFO_MODEL"
	}
	ACTIVE (FIND_STRING(TXT,"'DATA INFO_VERSION '",1)) :
	{
	    REMOVE_STRING(TXT,"'DATA INFO_VERSION '",1)
	    INFO_VERSION = TXT
	    IF (BRAND_MODEL_DEBUG) SEND_STRING 0, "'MIMO1212 - VERSION: ', INFO_VERSION"
	}
	ACTIVE (FIND_STRING(TXT,"'DATA INFO_MAC '",1)) :
	{
	    REMOVE_STRING(TXT,"'DATA INFO_MAC '",1)
	    INFO_MAC = TXT
	    IF (BRAND_MODEL_DEBUG) SEND_STRING 0, "'MIMO1212 - MAC_ADDRESS: ', INFO_MAC"
	...
	ACTIVE (FIND_STRING(TXT,"'DATA ILEVEL '",1)) :
	{
	    ...
	    TEMP2 = ATOI(TXT)
	    IF (BRAND_MODEL_DEBUG) SEND_STRING 0, "'MIMO1212 - INPUT: ', ITOA(TEMP), ' , LEVEL: ',ITOA(TEMP2)"
	...
	ACTIVE (FIND_STRING(TXT,"'DATA OLEVEL '",1)) :
	{
	    ...
	    TEMP = ATOI(REMOVE_STRING(TXT,' ',1))
	    TEMP2 = ATOI(TXT)
	    IF (BRAND_MODEL_DEBUG) SEND_STRING 0, "'MIMO1212 - OUTPUT: ', ITOA(TEMP), ' , LEVEL: ',ITOA(TEMP2)"
	...
	ACTIVE (FIND_STRING(TXT,"'DATA IMUTE '",1)) :
	{
	    ...
	    TEMP = ATOI(REMOVE_STRING(TXT,' ',1))
	    IF (BRAND_MODEL_DEBUG) SEND_STRING 0, "'MIMO1212 - OUTPUT: ', ITOA(TEMP), ' , MUTE: ',TXT"
	...
	ACTIVE (FIND_STRING(TXT,"'DATA XMUTE '",1)) :
	{
	    ...
	    {
		IF (BRAND_MODEL_DEBUG) SEND_STRING 0, "'MIMO1212 - CROSS OFF: IN ', ITOA(TEMP), ' , OUT: ',ITOA(TEMP2)"
		SEND_STRING BRAND_MODEL_vdv_Device,"'CROSS_OFF=', ITOA(TEMP), ':',ITOA(TEMP2)"
	    }
	    ELSE
	    {
		IF (BRAND_MODEL_DEBUG) SEND_STRING 0, "'MIMO1212 - CROSS ON: IN ', ITOA(TEMP), ' , OUT: ',ITOA(TEMP2)"
	...
	{
	    //SEND_STRING BRAND_MODEL_vdv_Device,"'MIMO1212 - HEARTBEAT'"
	    //IF (BRAND_MODEL_DEBUG) SEND_STRING 0, "'MIMO1212 - HEARTBEAT'"
	}
	...
	{
	    //CLEAR BUFFER?!?!
	    //SEND_STRING BRAND_MODEL_vdv_Device,"'MIMO1212 - UNKNOWN STRING RECEIVED! - ', TXT"
	    IF (BRAND_MODEL_DEBUG) SEND_STRING 0, "'MIMO1212 - UNKNOWN STRING RECEIVED! - ', TXT"
...
{
    IF (BRAND_MODEL_DEBUG) SEND_STRING 0, "'MIMO1212 RECALL_PRESET ', PRESET"
...
{
    IF (BRAND_MODEL_DEBUG) SEND_STRING 0, "'MIMO1212 SET_CROSS_ON ',_IN,' - ',_OUT"
...
{
    IF (BRAND_MODEL_DEBUG) SEND_STRING 0, "'MIMO1212 SET_CROSS_OFF ',_IN,' - ',_OUT"
...
DEFINE_CALL 'MUTE_IN'(CHAR INPUT[], INTEGER STATO)
{
    IF (STATO)
    {
	IF (BRAND_MODEL_DEBUG) SEND_STRING 0, "'MIMO1212 MUTE_IN ', INPUT"
	CALL 'BRAND_MODEL_SEND_STRING' ("'SET IMUTE ',INPUT, ' YES'")
	CALL 'BRAND_MODEL_SEND_STRING' ("'GET IMUTE ',INPUT")
    }
    ELSE
    {
	IF (BRAND_MODEL_DEBUG) SEND_STRING 0, "'MIMO1212 UN_MUTE_IN ', INPUT"
...
DEFINE_CALL 'MUTE_OUT'(CHAR OUTPUT[], INTEGER STATO)
{
    IF (STATO)
    {
	IF (BRAND_MODEL_DEBUG) SEND_STRING 0, "'MIMO1212 MUTE_OUT ', OUTPUT"
	CALL 'BRAND_MODEL_SEND_STRING' ("'SET OMUTE ',OUTPUT, ' YES'")
	CALL 'BRAND_MODEL_SEND_STRING' ("'GET OMUTE ',OUTPUT")
    }
    ELSE
    {
	IF (BRAND_MODEL_DEBUG) SEND_STRING 0, "'MIMO1212 UN_MUTE_OUT ', OUTPUT"
...
DEFINE_CALL 'INC_LEVEL'(CHAR CH[], INTEGER TYPE) // 1=INPUT  2=OUTPUT
{
    IF (TYPE == 1)
    {
	IF (BRAND_MODEL_DEBUG) SEND_STRING 0, "'MIMO1212 INC_LEVEL INPUT CH ',CH"
	CALL 'BRAND_MODEL_SEND_STRING' ("'INC ILEVEL ', CH, ' 2'")
    }
    ELSE IF (TYPE == 2)
    {
	IF (BRAND_MODEL_DEBUG) SEND_STRING 0, "'MIMO1212 INC_LEVEL OUTPUT CH ',CH"
...
DEFINE_CALL 'DEC_LEVEL'(CHAR CH[], INTEGER TYPE) // 1=INPUT  2=OUTPUT
{
    IF (TYPE == 1)
    {
	IF (BRAND_MODEL_DEBUG) SEND_STRING 0, "'MIMO1212 DEC_LEVEL INPUT CH ',CH"
	CALL 'BRAND_MODEL_SEND_STRING' ("'DEC ILEVEL ',CH, ' 2'")
    }
    ELSE IF (TYPE == 2)
    {
	IF (BRAND_MODEL_DEBUG) SEND_STRING 0, "'MIMO1212 DEC_LEVEL OUTPUT CH ',CH"
...
DATA_EVENT[BRAND_MODEL_vdv_Device]
{
	...
	SELECT
	{
		...
		IF (BRAND_MODEL_DEBUG) SEND_STRING 0, "'MIMO1212 PASSTHRUGH: ', BRAND_MODEL_vdv_BUFF"
